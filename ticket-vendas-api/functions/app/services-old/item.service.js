...
class ItemService {
  ...
  */
  ...
  getById(id, idItem, tipoItem) {
    if (tipoItem == '0')
      return veiculoModel.rebuild(`/usuarios/${id}/veiculos`).findById(idItem);
    else if (tipoItem == '1')
  ...
  create(usuario, item, tipoItem) {
    if (tipoItem == '0') {
      // console.log(usuario.veiculosDisponiveis > 0);
  ...
  update(id, idItem, item, tipoItem) {
    if (tipoItem == '0')
